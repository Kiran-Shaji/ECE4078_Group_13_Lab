...
if __name__ == "__main__":
    ...
    parser.add_argument("--map", type=str, default='W10_helpdesk_full.txt') # change to 'M4_true_map_part.txt' for lv2&3
    ...
    while True:
        ...
        #robot_pose = get_robot_pose()
         # Example usage:
        file_path = 'W10_helpdesk_full.txt'  # Replace with your actual file path
        ...
        for fruit in shopping_list:
            ...
            rrt = RRT(start=start, goal=goal, width=3, height=3, obstacle_list=obstacle_circles,
